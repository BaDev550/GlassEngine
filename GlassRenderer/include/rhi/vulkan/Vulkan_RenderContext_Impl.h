...
#define VK_ALLOCATOR_CALLBACKS &::ge::graphics::Vulkan_AllocatorCallbacks::GetCallbacks()
...
namespace ge::graphics {
	...
	VK_DEFINE_EXT_FUNC(vkGetDeviceFaultInfoEXT);
	...
	public:
		...
		virtual void RemoveReadonlyImageHandle(uint32_t i) override;
		virtual void RemoveWritableImageHandle(uint32_t i) override;
		virtual void RemoveSamplerHandle(uint32_t i) override;
		...
		[[nodiscard]] Vulkan_Allocator& GetAllocator() const noexcept { return *_allocator; }
	...
	private:
		...
		mem::Scope<Vulkan_DescriptorManager> _descriptorManager;

		uint32_t _graphicsQueueFamilyIndex{};
		VkQueue _graphicsQueue = VK_NULL_HANDLE;

		GLFWwindow* _window = nullptr;
		Vulkan_Allocator* _allocator = nullptr;
