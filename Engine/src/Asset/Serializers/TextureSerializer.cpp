#include "Asset/Serializers/TextureSerializer.h"
#include <cstdint>
...
namespace ge {
    // Source texture
    AssetType SourceTextureSerializer::ImportFromSource(const ImportAssetData& asset, const filesystem::Path& source, const filesystem::Path& targetPath) { // TODO(badev): rewrite this
    ...
    mem::Ref<Asset> SourceTextureSerializer::ImportTextureFromFile(const ImportAssetData& asset, const filesystem::Path& source)
    {
        int width, height, channels;
