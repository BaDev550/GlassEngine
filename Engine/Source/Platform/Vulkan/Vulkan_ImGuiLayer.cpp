...
namespace ge {
	Vulkan_ImGuiLayer::Vulkan_ImGuiLayer()
	{
		...
		poolSize.push_back({ VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER,   1000 });
		poolSize.push_back({ VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER,   1000 });
		poolSize.push_back({ VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC, 1000 });
		poolSize.push_back({ VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC, 1000 });
		poolSize.push_back({ VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT,      1000 });
