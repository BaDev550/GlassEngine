...
namespace ge::renderer {
	...
	public:
		Shader(std::string_view shaderName, ShaderData&& shaderData) : _shaderName(shaderName), _shaderData(std::move(shaderData)) {}
		~Shader() {}
		...
		static AssetType GetStaticAssetType() { return AssetType::SourceShader; }
		virtual AssetType GetAssetType() const override final { return GetStaticAssetType(); }
	protected:
